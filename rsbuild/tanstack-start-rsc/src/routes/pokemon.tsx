    ...
    <div className="py-10">
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-200">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Pokemon (Traditional SSR)</h1>
          <p className="text-gray-600 mb-4">
            This list was fetched in the loader and rendered as a normal React component. The data
            is serialized to JSON and sent to the client, where the component re-renders with that
            data.
          </p>

          <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
            <p className="text-amber-800 text-sm">
              <strong>Note:</strong> Unlike the RSC version, this page sends the full Pokemon data
              as JSON in the initial HTML payload. The component code also ships to the client and
              re-hydrates. Check the Network tab to compare payload sizes!
            </p>
          </div>
