...
import { createCompositeComponent, renderToReadableStream } from '@tanstack/react-start/rsc';
...
export const getProductPage = createServerFn().handler(async () => {
  ...
  const src = await createCompositeComponent(
    (props: {
      ...
      renderAlsoBought?: (data: { products: Array<AlsoBoughtProduct> }) => React.ReactNode;
    }) => (
      <div className="border-6 border-solid border-blue-500 rounded-xl p-6 bg-white shadow-lg">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-1/2 flex flex-col">
            ...
            <p className="text-3xl font-bold text-gray-900 mt-4">${mainProduct.price}</p>
