  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-xs text-gray-500 bg-gray-50 p-3 rounded-lg">
        <strong>How it works:</strong> Each ticker item is a React Server Component rendered on the
        server with <code>renderToReadableStream</code>, streamed as a Flight payload, and decoded
        on the client with <code>createFromReadableStream</code>. The "received X seconds ago" text
