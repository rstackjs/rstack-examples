...
function ApiServerComponent() {
  ...
  return (
    <div className="p-4 bg-linear-to-r from-emerald-500 to-teal-600 rounded-lg text-white">
      ...
      <p className="text-emerald-100 text-sm mt-1">This component was streamed from /api/rsc</p>
      <p className="text-emerald-200 text-xs mt-2 font-mono">Timestamp: {timestamp}</p>
    </div>
  );
}
